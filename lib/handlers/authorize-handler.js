...
function AuthorizeHandler(options) {
  ...
  this.allowThrowingExternalErrors = options.allowThrowingExternalErrors;
    ...
    .spread(function(expiresAt, client, user) {
      ...
      return Promise.bind(this)
        ...
        .then(function(authorizationCode) {
          ...
          return this.saveAuthorizationCode(authorizationCode, expiresAt, scope, client, redirectUri, user);
        })
        .then(function(code) {
        ...
        .catch(function(e) {
          ...
          throw this.allowThrowingExternalErrors ? originalError : e;
        });
    });
};
